<%-- 
    Document   : viewProcessingOrders
    Created on : Mar 23, 2022, 10:49:42 AM
    Author     : ADMIN
--%>
            ...
            <table class="order">
                ...
                <tr><td><%= ord.getOrderID()%></td>
                    ...
                    <td><%= status[ord.getStatus()]%>
                        <%if (ord.getStatus()==1) %><a href="mainController?action=cancelorderforuser&orderid=<%= ord.getOrderID()%>">cancel order</a></td>

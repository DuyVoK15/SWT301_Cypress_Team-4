...
public class insertPlantServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            String pname = request.getParameter("newpname");
            ...
            int CateID = Integer.parseInt(request.getParameter("newcateid"));
            PlantDao.insertPlant(pname, price, imgpath, description, status, CateID);
